...
const colors = {
  50: "#fff0f5", // light pink blush
  100: "#ffc1e3", // soft pink
  200: "#ff99cc", // bubblegum pink
  300: "#ff66b2", // hot pink
  400: "#ff3385", // neon pink
  500: "#ff0066", // intense pink/red
  600: "#e6004c", // strong hot red-pink
  700: "#cc0033", // bold red
  800: "#990026", // deep crimson
  900: "#66001a", // almost black cherry
};
...
export default function Hero() {
  ...
  return (
    <div className="font-primary relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-[#1a1d18] via-black to-[#2a2e26] text-[#ffc042]">
      <Header />

      <svg
        className="absolute inset-0 h-full w-full blur-[2px]"
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-between px-8 py-12 md:px-16 md:py-20">
        ...
        <div className="text-center">
          <h2
            className="font-mono text-xs font-light tracking-[0.2em] uppercase opacity-80 md:text-sm flex gap-2 justify-center"
        ...
        <div className=" max-w-5xl text-center">
          ...
          >
            <div className="mb-4 md:mb-6  text-center min-w-full items-center flex gap-2 justify-center">
            ...
            <div
              className="text-2xl leading-relaxed font-thin md:text-3xl lg:text-4xl gap-2 flex items-center justify-center"
              style={{ color: colors[200] }}
            >
